...
import 'package:praecoxproject/medicants_screen/VeryMildDemented/verymilddementedscreen3.dart';
import '../../style/app_colors.dart';
class VeryMildDementedScreen2 extends StatelessWidget {
  const VeryMildDementedScreen2({super.key});
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>const VeryMildDementedScreen()));
            },
          ),
          ...
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>const VeryMildDementedScreen3()));
              },
              child: const Text(
                'Next',
                style: TextStyle(
